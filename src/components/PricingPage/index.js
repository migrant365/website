                ...
                <Grid item xs>
                  <Box
                    ...
                    <Box
                      ...
                      <Typography sx={{ color: "#3c486b", fontWeight: "700" }}>
                        {elem.title}
                      </Typography>
                      {elem.isPopular && (
                        <Box
                    ...
                    <Box
                      ...
                      <Typography sx={{ color: "#3c486b", marginTop: "16px" }}>
                        {elem.subtitle}
                      </Typography>
                    </Box>
                    <Box sx={{ padding: "22px" }}>
                ...
                <Box
                  ...
                  <Box
                    ...
                    <Typography
                      ...
                      mobile apps, are typically completed within 1 to 2 weeks.
                      For more complex projects, like custom web applications or
                      advanced mobile solutions, the timeline can extend to 1 to
                      3 months to allow for thorough design, development, and
                      testing.
                    </Typography>
                  </Box>
                </Box>
