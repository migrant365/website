...
const AboutPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Us - Migrant365</title>
      </Helmet>
              ...
              <Grid item xs>
                ...
                <Box sx={{ marginTop: "36px" }}>
                  <Typography sx={{ color: "#3c468b" }}>
                    ...
                    expertise in web development, mobile applications, and
                    design. Our commitment is to craft custom, high-quality
                    digital solutions that are tailored to meet the unique needs
                    and challenges of each client. By blending creativity with
